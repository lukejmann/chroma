  ...
  },
  {
    ...
    description: (
      <>
        ...
        <ExternalLink href="https://help.mann.xyz/en/articles/5675203-terms-of-service-faq">
    ...
    >
      <AutoColumn gap="16px">
        <AutoColumn gap="8px" style={{ width: '100%' }}>
          <StyledExternalCard>
            <ExternalLink href={'https://mann.xyz/terms-of-service'}>
              <RowBetween>
                <AutoRow gap="4px">
                  <Info size={20} />
          ...
          <StyledExternalCard>
            <ExternalLink href={'https://mann.xyz/disclaimer/'}>
              <RowBetween>
                <AutoRow gap="4px">
                  <Info size={20} />
                  <ThemedText.Main fontSize={14} color={'primaryText1'}>
