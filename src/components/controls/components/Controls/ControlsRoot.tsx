...
import { mergeTheme, ControlsCustomTheme, globalStyles } from "../../styles";
import {
  ThemeContext,
  StoreContext,
...
export type ControlsRootProps = {
  /**
   * Theme with Stitches tokens
   */
  theme?: ControlsCustomTheme;
  /**
  ...
  titleBar?:
    ...
    | {
        ...
        /**
         * Toggle whether the controls panel can be dragged around via the title bar.
         */
        drag?: boolean;
        /**
        ...
        filter?: boolean;
        /**
         * The position(x and y coordinates) of the controls panel.
         */
        position?: { x?: number; y?: number };
        /**
         * The callback is called when the controls panel is dragged.
         */
        onDrag?: (position: { x?: number; y?: number }) => void;
        /**
         * The callback is called when the controls panel starts to be dragged.
         */
        onDragStart?: (position: { x?: number; y?: number }) => void;
        /**
         * The callback is called when the controls panel stops being dragged.
         */
...
type ControlsCoreProps = Omit<
  ControlsRootProps,
  "theme" | "hidden" | "collapsed"
> & {
  store: StoreType;
  rootClass: string;
  toggled: boolean;
