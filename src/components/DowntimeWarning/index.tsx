      ...
      return (
        <Wrapper>
          <Trans>
            ...
            liquidity.{' '}
            <ReadMoreLink href="https://help.mann.xyz/en/articles/5406082-what-happens-if-the-optimistic-ethereum-network-experiences-downtime">
              Read more.
            </ReadMoreLink>
          </Trans>
        </Wrapper>
      ...
      return (
        <Wrapper>
          <Trans>
            ...
            <ReadMoreLink href="https://help.mann.xyz/en/articles/5576122-arbitrum-network-downtime">
              Read more.
            </ReadMoreLink>
          </Trans>
        </Wrapper>
